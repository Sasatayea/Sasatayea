...
| ** Spring Dashboard App**           | Full API for managing Movies Resources From IMDB open API, Appling (Projection, Pagination, Validators, Exception Handling, Swagger UI, Rest API).                                       | Java, Spring Boot, MySQL, Spring Security                 | [Repo](https://github.com/Sasatayea/Spring-boot-Dashboard-api.git)                       |
