...
|-------------------------------------|-----------------------------------------------------------------------------------------------------------|--------------------------------------------|----------------------------------------------------------------------------|
| **Books Store**                     | Full Api using Spring data jpa contain (Projection, Pagination, Validators, Exception Handling, Logging,ShedLock, Actuator, AWS S3, Swagger UI, AOP)  | Java, Spring Boot, MySQL                   | [Repo](https://github.com/Sasatayea/data-jpa-books-project.git)            |
|                                     |                                                              |                                                                                                                         |
